[Спробувати шрифти](https://volempdoge.github.io/betaflight-designer-fonts/uk/) · [English](README.md) · [Довідник символів](docs/SYMBOLS_UA.md) · [Доки для розробників](docs/DEVELOPERS_UA.md)
...
| Пунктуація | – — … « » ‹ › “ ” ‘ ’ „ • · ¿ ¡ ° ′ ″ § — і `$ ~` \`, які у вихідному шрифті зайняті іконками, а також `{ }` |
